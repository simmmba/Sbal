...
const UserStore = observable({
  ...
  cityAndTowns: {
    ...
    경기: ['가평군', '고양시', '고양시 덕양구', '고양시 일산동구', '고양시 일산서구', '과천시',
    ...
    충북: ['괴산군', '단양군', '보은군', '영동군', '옥천군', '음성군', '제천시', '증평군', '진천군',
      '청주시', '청주시 상당구', '청주시 서원구', '청주시 청원구', '청주시 흥덕구', '충주시'],
    충남: ['계룡시', '공주시', '금산군', '논산시', '당진시', '보령시', '부여군', '서산시', '서천군',
      '아산시', '예산군', '천안시', '천안시 동남구', '천안시 서북구', '청양군', '태안군', '홍성군'],
    대전: ['대덕구', '동구', '서구', '유성구', '중구'],
    ...
    경북: ['경산시', '경주시', '고령군', '구미시', '군위군', '김천시', '문경시', '봉화군',
      ...
      '울진군', '의성군', '청도군', '청송군', '칠곡군', '포항시', '포항시 남구', '포항시 북구'],
    대구: ['남구', '달서구', '달성군', '동구', '북구', '서구', '수성구', '중구'],
    경남: ['거제시', '거창군', '고성군', '김해시', '남해군', '밀양시', '사천시', '산청군', '양산시',
      '의령군', '진주시', '창녕군', '창원시', '창원시 마산합포구', '창원시 마산회원구', '창원시 성산구',
  ...
  interests: {
    개발: ['.NET', 'C/C++', 'Node.js', 'PHP', 'iOS', 'UI/UX Design', 'Ruby on rails', 'Machine Learning', 'Security',
      'Big Data', 'Server', 'Android', 'Algorithms', '영상/음성처리', 'Web', 'Java', 'Python', 'Publisher', 'Front-End'],
    어학: ['BCT', 'HSK', 'JLPT', 'JPT', 'Opic', 'TOEFL', 'TOEIC', 'TOEIC Speaking'],
    취업: ['자소서', 'NCS','인적성', '면접']
  },

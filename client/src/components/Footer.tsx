...
const Footer = () => {
    return (
        <WrapperDiv>
            <small>Samsung Software Academy For Youth.<br/>멀티캠퍼스 서울 특별시 강남구 언주로 508(역삼동, 서울상록빌딩)</small><br/>
            <NormalP><small>Copyright by 서울 A306 600NotFound Team. All rights reserved.</small></NormalP>
            <small>
